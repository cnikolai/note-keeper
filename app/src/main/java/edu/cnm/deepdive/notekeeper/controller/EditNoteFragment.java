...
public class EditNoteFragment extends BottomSheetDialogFragment implements TextWatcher {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    EditNoteFragmentArgs args = EditNoteFragmentArgs.fromBundle(getArguments()); //generated for us by navigation framework
    noteId = args.getNoteId(); //autogenerated getNoteId from navgraph argument name
  }
